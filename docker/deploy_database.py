# This file is copy of database.py file under "../server/llm_system/core/database.py"
# Only change here is replacement of OllamaEmbeddings with GoogleGenerativeAIEmbeddings 
